...
public class ScaryMaze extends JPanel implements Runnable, MouseMotionListener {
	...
	ScaryMaze() throws Exception {
		...
		maze = ImageIO.read(getClass().getResource("hi.jpg"));
...
JOptionPane.showMessageDialog(null, "ha! You failed");
	...
	private void scare() {
		...
		AudioClip sound = JApplet.newAudioClip(getClass().getResource("foop.wav"));
...
sound.play();
		...
		showScaryImage("ahhhhhhh.jpg");
	}

	private void showScaryImage(String ahhhhhhh) {
		try {
			maze = ImageIO.read(getClass().getResource(ahhhhhhh));
		} catch (Exception e) {
			System.err.println("Couldn't find this image: " + ahhhhhhh);
		}
		repaint();
	}
